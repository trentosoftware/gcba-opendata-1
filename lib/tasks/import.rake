namespace :import do
  ...
  task :data do
    ...
    cmd = 'psql -d \'gcba-opendata-dev\' -h localhost -U gcba -c "copy parcelas_geometry(seccion,manzana,parcela,smp,geometry) from \'' + s.chomp + '/db/migrate/insert_geometry_data2.csv\' DELIMITERS \'#\' csv"'
